...
(defun Add_item()
	...
	(setq Tipo (read))
	(if (= Tipo 5)
		(Escrever_item "f:/Zubber/arquivos/Itens_restaurantes.txt" 5)
	)    
	(if (= Tipo 4)
		(Escrever_item "f:/Zubber/arquivos/Itens_farmacias.txt" 4)
	)    
	(if (= Tipo 3)
		(Escrever_item "f:/Zubber/arquivos/Itens_supermercados.txt" 3)
	)    
	(if (= Tipo 2)
		(Escrever_item "f:/Zubber/arquivos/Itens_livrarias.txt" 2)
	)
)
