...
(defun Ler_local()
	...
	(with-open-file (stream "f:/Zubber/arquivos/Locais.txt")
...
(defun Ler_motoristas()
	...
	(with-open-file (stream "f:/Zubber/arquivos/Motoristas.txt")
		(do ((line (read-line stream nil) (read-line stream nil)))
			((null line))
			(setq Aux (split line))
			(print Aux)
...
(defun Add_motorista()
	...
	(with-open-file (f "f:/Zubber/arquivos/Motoristas.txt":direction :output 
																				   :if-exists :append 
...
(defun Add_local()
    ...
    (with-open-file (f "f:/Zubber/arquivos/Locais.txt":direction :output 
																			 :if-exists :append 
																			 :if-does-not-exist :create)
		(write-line Linha f))
)
